...
public class Celebrity_Activity extends BaseActivity {
    ...
    private class CelebrityWall extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            final String jsonCat = sh.makeServiceCall("https://wall.alphacoders.com/api2.0/get.php?auth=321a42093f3753ca40879d07bcfbd714&method=category&id=7&page=1&info_level=2");
