...
public class RvcatAdapter extends RecyclerView.Adapter<RvcatAdapter.MyViewHolder> {
    ...
    public RvcatAdapter(Context mContext, List lst) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.cat_row_items,parent,false);

        final RvcatAdapter.MyViewHolder viewHolder = new RvcatAdapter.MyViewHolder(view);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            wallname = itemView.findViewById(R.id.thumb_namecat);
            wallThumb = itemView.findViewById(R.id.thumbcat);
            hdWall = itemView.findViewById(R.id.imageView);
            view_cont = itemView.findViewById(R.id.contcat);
