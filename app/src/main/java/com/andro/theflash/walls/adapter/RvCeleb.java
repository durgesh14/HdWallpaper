...
public class RvCeleb extends RecyclerView.Adapter<RvCeleb.MyViewHolder>{
    RequestOptions options ;
    private Context mContext ;
    private List<Walls> mData;

    public RvCeleb(Context mContext, List lst) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.celeb_row_item,parent,false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            wallname = itemView.findViewById(R.id.thumb_nameceleb);
            wallThumb = itemView.findViewById(R.id.thumbceleb);
            hdWall = itemView.findViewById(R.id.imageView);
            view_cont = itemView.findViewById(R.id.contceleb);
