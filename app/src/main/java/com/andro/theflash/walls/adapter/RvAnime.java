...
public class RvAnime extends RecyclerView.Adapter<RvAnime.MyViewHolder>{
    ...
    public RvAnime(Context mContext, List lst) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            wallname = itemView.findViewById(R.id.thumb_nameanime);
            wallThumb = itemView.findViewById(R.id.thumbanime);
            hdWall = itemView.findViewById(R.id.imageView);
            view_cont = itemView.findViewById(R.id.contanime);
